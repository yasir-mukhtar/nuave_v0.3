    ...
    <footer style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px' }}>
          ...
          <span style={{ fontWeight: 600, fontSize: '18px', color: '#111827' }}>Nuave</span>
        </div>
        ...
        {/* Legal Links */}
        <div className="text-label-12" style={{ display: "flex", alignItems: "center", gap: "12px", color: "var(--text-muted)" }}>
